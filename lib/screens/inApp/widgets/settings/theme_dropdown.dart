...
class _CustomThemeDropdownState extends State<CustomThemeDropdown> {
  ...
  @override
  void didUpdateWidget(covariant CustomThemeDropdown oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Listener(
      onPointerDown: (context) => _setPressed(true),
      onPointerUp: (context) {
      ...
      onPointerCancel: (context) => _setPressed(false),
